...
function initJobState(job) {
    let state = { job: job, _0x0038: false, _0x0039: 0, _0x0049: 0, _0x001c: 0, _0x0021: 0, _0x002c: 0, _0x0030: 0, _0x000d: 0, _0x0032: 0 };
    
    // 해커
    if (job === "해커") {
        state._0x003a = 0; state._0x006a = 0; state._0x0054 = 0;
        state._0x006e = 0;
        state._0x0017 = 0; state._0x0046 = 0; state._0x0023 = 0;
    }
    // 투자자
    else if (job === "투자자") {
        state._0x0031 = 20; state._0x000a = 0; state._0x0026 = 0; state._0x0015 = false;
    }
    // 환자
    else if (job === "환자") {
        state._0x004a = 0; // 강박증
        state._0x0010 = 0; state._0x0003 = 0; // 환각증
    }
    // 수집가
    else if (job === "수집가") {
        state._0x000e = [];
        state._0x0047 = 0;
        state._0x0040 = 0; state._0x007a = 0; state._0x0061 = 0;
    }
    // 감시자
    else if (job === "감시자") {
        state._0x005d = 30;
        state._0x002d = 0; state._0x0062 = 0; state._0x0009 = 0;
    }
    // 뜀틀선수
    else if (job === "뜀틀선수") {
        state._0x0037 = 0; state._0x0069 = 0; state._0x0076 = 3;
        state._0x005e = 0;
    }
    // 전우치
    else if (job === "전우치") {
        state._0x002a = 0;
        state._0x0011 = 0; state._0x0035 = 0;
    }
    // 기관사
    else if (job === "기관사") {
        state._0x002e = 8;
    ...
    // 비밀요원
        ...
        state._0x001b = 0; state._0x0056 = 0;
    }
    // 67
    else if (job === "67") {
        state._0x000c = 0;
    ...
    // 사과
        ...
        state._0x0001 = 0; state._0x0012 = 0; state._0x000f = 0;
        state._0x006c = 0;
    }
    // 시인
    else if (job === "시인") {
        state._0x0016 = 0; state._0x0044 = 0;
        state._0x0002 = 0; state._0x0013 = 0;
    }
    // 공룡
    else if (job === "공룡") {
        state._0x0019 = 0; state._0x0057 = 0; state._0x0034 = false;
        state._0x0064 = 0;
        state._0x0073 = 0; state._0x0068 = false;
    }
    // 마법사
    else if (job === "마법사") {
        state._0x003d = 0; state._0x0074 = 0;
        state._0x0036 = 0;
    }
    // 사신
    else if (job === "사신") {
        state._0x0029 = 44;
        state._0x002f = 0; state._0x006b = 0;
    }
    // 수학자
    else if (job === "수학자") {
        state._0x0066 = 0;
        state._0x004c = 0; state._0x0078 = 0;
        state._0x0053 = 0; state._0x007e = 0;
        state._0x0080 = 0;
        state._0x007d = 0;
        state._0x001f = 0; state._0x004e = 0; state._0x0004 = false;
        state._0x004b = 0;
    }
    // 생존자
    else if (job === "생존자") {
        state._0x0025 = 0; state._0x0024 = "";
        state._0x0022 = 0; state._0x0067 = 0;
        state._0x0007 = 0;
    }
    // 악당
    else if (job === "악당") {
        state._0x001e = 0; state._0x004f = 0; state._0x0042 = 0; state._0x001d = [];
        state._0x001a = 0; state._0x004d = 0;
    }
    // 기자
    else if (job === "기자") {
        state._0x0027 = 0; state._0x005a = 0; state._0x0051 = 0;
    }
    // 검객
    else if (job === "검객") {
        state._0x0043 = 0; state._0x0079 = 0;
        state._0x003c = 0; state._0x006d = 0; state._0x0050 = false;
    }
    // 마하트마간디
    else if (job === "마하트마간디") {
        state._0x0028 = 0; state._0x003f = 0;
        state._0x0018 = 0;
    }
    // 은하계전사
    else if (job === "은하계전사") {
        state._0x0045 = 0; state._0x005f = 0; state._0x0008 = false;
    }
    // 수리사
    else if (job === "수리사") {
        state._0x0006 = 0;
        state._0x002b = 0; state._0x005b = 0; state._0x0048 = false;
    }
...
function buildStatusMsg(game) {
    ...
    let currentPlayer = game.players[game._0x0020];
    let nextPlayer = game.players[(game._0x0020 + 1) % 2];
    
    let curState = game._0x0052[currentPlayer];
    let nxtState = game._0x0052[nextPlayer];
    ...
    function makePlayerInfo(name, state, otherState) {
        ...
        let _0x0060 = [];
        if (state.job === "해커") {
            _0x0060.push("조작 " + (3 - state._0x006a) + "회/쿨 " + state._0x003a + "턴");
            _0x0060.push("복제 " + (1 - state._0x006e) + "회");
            _0x0060.push("초토화 " + (2 - state._0x0046) + "회/쿨 " + state._0x0017 + "턴");
            if (state._0x0054 > 0) buff.push("- 조작 활성화: " + state._0x0054 + "턴간 중복 단어 가능");
            if (state._0x0023 > 0) buff.push("- 초토화 장전: 다음 턴 발동");
        } else if (state.job === "투자자") {
            _0x0060.push("주가 조작 " + (2 - state._0x0026) + "회/쿨 " + state._0x000a + "턴");
            etc.push("- 현재 주가: " + state._0x0031 + " / 타겟: " + game._0x0077);
            if (state._0x0015) buff.push("- 주가 조작 장전: 다음 턴 강제 차감");
        } else if (state.job === "환자") {
            _0x0060.push("강박증 쿨 " + state._0x004a + "턴");
            _0x0060.push("환각증 " + (1 - state._0x0010) + "회");
            if (state._0x0003 > 0) debuff.push("- 환각증 여파: " + state._0x0003 + "턴간 예외단어(한방/유도) 불가");
        } else if (state.job === "수집가") {
            _0x0060.push("제작 쿨 " + state._0x0047 + "턴");
            _0x0060.push("채굴 " + (2 - state._0x007a) + "회/쿨 " + state._0x0040 + "턴");
            etc.push("- 수집된 음절: [" + state._0x000e.join(", ") + "]");
            if (state._0x0061 > 0) buff.push("- 채굴 활성화: 1턴간 모든 음절 수집");
        } else if (state.job === "감시자") {
            _0x0060.push("탐지 " + (2 - state._0x0062) + "회/쿨 " + state._0x002d + "턴");
            etc.push("- 현재 감시 수: " + state._0x005d);
            if (state._0x0009 > 0) buff.push("- 탐지 활성화: 다음 감시 패시브 2배");
        } else if (state.job === "뜀틀선수") {
            _0x0060.push("뜀틀 " + (state._0x0076 - state._0x0069) + "회/쿨 " + state._0x0037 + "턴");
            _0x0060.push("허들 넘기 " + (1 - state._0x005e) + "회");
        } else if (state.job === "전우치") {
            _0x0060.push("잔상 " + (1 - state._0x002a) + "회");
            _0x0060.push("직격뢰 " + (4 - state._0x0035) + "회/쿨 " + state._0x0011 + "턴");
        } else if (state.job === "기관사") {
            etc.push("- 남은 전철역 수: " + state._0x002e);
        } else if (state.job === "늑대인간") {
            _0x0060.push("포효 쿨 " + state._0x0041 + "턴");
        } else if (state.job === "시프터") {
            _0x0060.push("시프트 " + (3 - state._0x0070) + "회");
        } else if (state.job === "비밀요원") {
            _0x0060.push("포획 " + (2 - state._0x0056) + "회/쿨 " + state._0x001b + "턴");
            etc.push("- 설정된 타깃 수: " + state._0x0082.length + (state._0x0082.length > 0 ? " [" + state._0x0082.join(",") + "]" : ""));
        } else if (state.job === "67") {
            _0x0060.push("67 쿨 " + state._0x000c + "턴");
        } else if (state.job === "사과") {
            _0x0060.push("사구아 " + (1 - state._0x006c) + "회");
            etc.push("- 삭와 미사용 지속: " + state._0x000f + "턴 / (쿨: " + state._0x0001 + ")");
            if (state._0x0012 > 0) debuff.push("- 사과 디버프: " + state._0x0012 + "턴간 3글자 이상 한방 및 5글자 이상 유도 불가");
        } else if (state.job === "시인") {
            _0x0060.push("2음절 " + (3 - state._0x0044) + "회/쿨 " + state._0x0016 + "턴");
            _0x0060.push("시적 허용 " + (2 - state._0x0013) + "회/쿨 " + state._0x0002 + "턴");
        } else if (state.job === "공룡") {
            _0x0060.push("삼키기 " + (2 - state._0x0057) + "회/쿨 " + state._0x0019 + "턴");
            _0x0060.push("브레스 " + (1 - state._0x0064) + "회, 꼬리 날리기 " + (1 - state._0x0073) + "회");
            if (state._0x0068) buff.push("- 꼬리 날리기: 다음 차례 능력 불가 무시");
        } else if (state.job === "마법사") {
            _0x0060.push("공허 " + (5 - state._0x0074) + "회/쿨 " + state._0x003d + "턴");
            _0x0060.push("폭발 " + (1 - state._0x0036) + "회");
            if (game._0x0077 <= 14) debuff.push("- 부작용: 14턴 이전까지 한방/유도 불가");
        } else if (state.job === "사신") {
            _0x0060.push("사형 선고 " + (4444 - state._0x006b) + "회/쿨 " + state._0x002f + "턴");
            etc.push("- 남은 처형 수: " + state._0x0029);
        } else if (state.job === "수학자") {
            _0x0060.push("계산 " + (2 - state._0x0078) + "회/쿨 " + state._0x004c + "턴");
            _0x0060.push("덧셈 " + (3 - state._0x007e) + "회/쿨 " + state._0x0053 + "턴");
            _0x0060.push("뺄셈 " + (2 - state._0x0080) + "회, 곱셈 " + (1 - state._0x007d) + "회");
            _0x0060.push("교정 " + (2 - state._0x004e) + "회/쿨 " + state._0x001f + "턴, 미적분 " + (1 - state._0x004b) + "회");
            // Result is hidden unless directly requested via active, but logic maintains it. (Or hide mostly).
        } else if (state.job === "생존자") {
            _0x0060.push("긴급 구조 " + (2 - state._0x0067) + "회/쿨 " + state._0x0022 + "턴");
            etc.push("- 모스부호: [" + state._0x0024 + "]");
        } else if (state.job === "악당") {
            _0x0060.push("결계 " + (4 - state._0x004f) + "회/쿨 " + state._0x001e + "턴");
            _0x0060.push("왜곡 " + (2 - state._0x004d) + "회/쿨 " + state._0x001a + "턴");
            if (state._0x0042 > 0) buff.push("- 결계 전개 중 (" + state._0x0042 + "턴 남음) : [" + state._0x001d.join(",") + "]");
        } else if (state.job === "기자") {
            _0x0060.push("거짓 보도 " + (4 - state._0x005a) + "회/쿨 " + state._0x0027 + "턴");
            if (state._0x0051 > 0) buff.push("- 방송 중: 상대방 패시브/능력/두음법칙 불가 (" + state._0x0051 + "턴 남음)");
        } else if (state.job === "검객") {
            _0x0060.push("찌르기 " + (2 - state._0x0079) + "회/쿨 " + state._0x0043 + "턴");
            _0x0060.push("가르기 " + (3 - state._0x006d) + "회/쿨 " + state._0x003c + "턴");
        } else if (state.job === "마하트마간디") {
            _0x0060.push("비폭력 스탯 쿨 " + state._0x0028 + "턴, 억제 쿨 " + state._0x0018 + "턴");
            etc.push("- 비폭력 스탯: " + state._0x003f);
        } else if (state.job === "은하계전사") {
            _0x0060.push("별달 패시브 쿨 " + state._0x0045 + "턴");
            etc.push("- 별달 스택: " + state._0x005f);
        } else if (state.job === "수리사") {
            _0x0060.push("수리 " + (4 - state._0x005b) + "회/쿨 " + state._0x002b + "턴");
        }

        if (state._0x0039 > 0) debuff.push("- 능력/패시브 상실 상태 (" + state._0x0039 + "턴 남음)");
        if (state._0x0038) debuff.push("- 능력 영구 상실 상태");
        if (state._0x0049 > 0) debuff.push("- 유도단어 불가 (" + state._0x0049 + "턴 남음)");
        if (state._0x001c > 0) debuff.push("- 한방단어 불가 (" + state._0x001c + "턴 남음)");
        if (state._0x0021 > 0) debuff.push("- 두음법칙 불가 (" + state._0x0021 + "턴 남음)");
        if (state._0x002c > 0) debuff.push("- 짝수 글자 수 단어만 허용 (" + state._0x002c + "턴 남음)");
        if (state._0x000d > 0) debuff.push("- 2글자 단어만 허용 (" + state._0x000d + "턴 남음)");
        if (state._0x0032 > 0) debuff.push("- " + state._0x0032 + "글자 이하 단어만 허용");
        if (state._0x000b > 0) debuff.push("- 비밀요원 타깃 포착 중 (" + state._0x000b + "턴 남음, 5글자 이상 금지)");
        
        if (otherState && otherState.job === "해커" && otherState._0x0023 > 0) {
    ...
    let msg = "기보\n\n" + historyStr + "\n\n" +
              game._0x0077 + "턴 | 채린룰 | 이을 음절 : " + nextChar + "\n\n" +
...
bot.addListener(Event.MESSAGE, function(event) {
    ...
    if (game) {
        ...
        // 투표 생성 로직
        if ((msg === PREFIX + "킥" || msg === PREFIX + "ㅋ") && (!game.kickVote || !game.kickVote.target) && game._0x0020 !== -1) {
            let target = game.players[game._0x0020];
            let timeDiff = now - game._0x0058;
        ...
        if (msg === PREFIX + "동의" || msg === PREFIX + "ㄷㅇ" || msg === PREFIX + "거절" || msg === PREFIX + "ㄱㅈ") {
            ...
            if (msg === PREFIX + "동의" || msg === PREFIX + "ㄷㅇ") {
                if (game.voteType === "무르기") {
                    ...
                    game._0x0020 = (game._0x003b + game.history.length) % 2;
                    game._0x0077 = Math.floor(game.history.length / 2) + 1;
    ...
    if (msg === PREFIX + "바꾸기" || msg === PREFIX + "ㅂㄲㄱ") {
        ...
        if (game.players.includes(sender)) {
            if (game.history.length === 1 && sender !== game.players[game._0x003b]) {
                game._0x003b = game.players.indexOf(sender);
                game._0x0020 = (game._0x003b + 1) % 2; // 차례가 원래 첫 대상자에게 넘어감
                replier.reply(sender + "님이 '" + game.history[0] + "' 단어를 빼앗아 처음 입장을 가져갔습니다.\n다음 차례: " + game.players[game._0x0020]);
            } else {
    ...
    if ((msg.startsWith(PREFIX + "직업 ") || msg.startsWith(PREFIX + "ㅈㅇ ")) && game && game.phase === "job_selection") {
        ...
        if (game._0x0052[sender]) { replier.reply("이미 직업을 선택하셨습니다."); return; }
        
        game._0x0052[sender] = initJobState(job);
        replier.reply(sender + "님 -> [" + job + "] 선택 완료");

        if (Object.keys(game._0x0052).length === 2) {
            game.phase = "playing";
            game._0x0058 = Date.now();
            let p1 = game.players[0];
            let p2 = game.players[1];
            let p1_job = game._0x0052[p1].job;
            let p2_job = game._0x0052[p2].job;
    ...
    if (msg.startsWith("2") && msg.length > 1) {
        ...
        let _0x0055 = abilityStr.split(" ");
        let ability = _0x0055[0];
        if (_0x0055.length > 1 && (ability === "주가" || ability === "거짓" || ability === "시적" || ability === "꼬리" || ability === "사형" || ability === "긴급" || ability === "허들")) {
            ability = _0x0055[0] + " " + _0x0055[1]; // 두 어절 스킬 이름 처리
            _0x0055.shift();
        }
        let _0x0063 = _0x0055.length > 1 ? _0x0055.slice(1).join(" ") : null;

        let state = game._0x0052[sender];
        let _0x0014 = state._0x0039 > 0 || state._0x0038;
        let _0x007c = (game.players.indexOf(sender) + 1) % 2;
        let _0x007f = game._0x0052[game.players[_0x007c]];

        if (state.job === "해커") {
            if (ability === "조작" && !_0x0014) {
                if (state._0x006a >= 3) { replier.reply("조작 능력을 모두 사용했습니다."); return; }
                if (state._0x003a > 0) { replier.reply("조작 쿨타임입니다. (" + state._0x003a + "턴 남음)"); return; }
                state._0x006a += 1; state._0x003a = 4; state._0x0054 = 2;
                replier.reply("[해커] <조작> 발동!\n- 이후 2턴간 이미 사용했던 단어를 재사용할 수 있습니다.");
            } else if (ability === "복제" && !_0x0014) {
                if (game._0x0077 < 7) { replier.reply("복제 능력은 7턴 이후부터 사용할 수 있습니다."); return; }
                if (state._0x006e >= 1) { replier.reply("복제 능력을 모두 사용했습니다."); return; }
                state._0x006e += 1;
                let _0x0072 = {
                    _0x0039: state._0x0039, _0x0049: state._0x0049, _0x001c: state._0x001c,
                    _0x0021: state._0x0021, _0x002c: state._0x002c, _0x0030: state._0x0030,
                    _0x000d: state._0x000d, _0x0032: state._0x0032, _0x000b: state._0x000b
                };
                Object.assign(_0x007f, _0x0072);
                Object.keys(_0x0072).forEach(k => state[k] = 0);
                replier.reply("[해커] <복제> 발동!\n- 내 모든 디버프를 제거하고 상대방에게 전송했습니다.");
            } else if (ability === "초토화" && !_0x0014) {
                if (game._0x0077 < 7) { replier.reply("초토화 능력은 7턴 이후부터 사용할 수 있습니다."); return; }
                if (state._0x0046 >= 2) { replier.reply("초토화 능력을 모두 사용했습니다."); return; }
                if (state._0x0017 > 0) { replier.reply("초토화 쿨타임입니다. (" + state._0x0017 + "턴 남음)"); return; }
                state._0x0046 += 1; state._0x0017 = 7; state._0x0023 = 1; 
                replier.reply("[해커] <초토화> 예약 발동!\n- 1턴 내 상대방이 4글자 이상의 단어를 사용하면 모든 능력을 잃습니다.");
            }
        }
        else if (state.job === "투자자" && !_0x0014) {
            if (ability === "주가 조작") {
                if (state._0x0026 >= 2) { replier.reply("주가 조작를 모두 사용했습니다."); return; }
                if (state._0x000a > 0) { replier.reply("주가 조작 쿨타임입니다."); return; }
                state._0x0026 += 1; state._0x000a = 7; state._0x0015 = true;
                replier.reply("[투자자] <주가 조작> 예약 발동!\n- 다음 턴 상대방이 제출하는 단어는 길이 상관없이 무조건 주가를 폭락시킵니다.");
            }
        }
        else if (state.job === "수집가" && !_0x0014) {
            if (ability === "제작") {
                if (!_0x0063 || _0x0063.length < 2) { replier.reply("2글자 이상의 추가단어를 지정해야 합니다."); return; }
                if (state._0x0047 > 0) { replier.reply("제작 쿨타임입니다."); return; }
                // 음절 소모 가능여부 (간소화 버젼: 보유한 배열에서 뺌)
                let _0x003e = state._0x000e.slice();
                let possible = true;
                for (let ch of _0x0063) {
                    let idx = _0x003e.indexOf(ch);
                    if (idx > -1) _0x003e.splice(idx, 1);
                    else { possible = false; break; }
                }
                if (!possible) { replier.reply("해당 단어를 제작하기 위한 수집 한글 음절이 부족합니다."); return; }
                state._0x000e = _0x003e;
                state._0x0047 = 6;
                if (!game._0x0059) game._0x0059 = new Set();
                game._0x0059.add(_0x0063);
                replier.reply("[수집가] 추가단어 제작 성공! 이제 '" + _0x0063 + "' 단어를 사용할 수 있습니다.");
            } else if (ability === "채굴") {
                if (state._0x007a >= 2) { replier.reply("채굴을 모두 사용했습니다."); return; }
                if (state._0x0040 > 0) { replier.reply("채굴 쿨타임입니다."); return; }
                state._0x007a++; state._0x0040 = 6; state._0x0061 = 1;
                replier.reply("[수집가] 채굴 발동! 1턴간 상대방이 사용한 단어의 모든 음절을 수집합니다.");
            }
        }
        else if (state.job === "환자") {
            if (ability === "환각증" && !_0x0014) {
                if (game._0x0077 < 7) { replier.reply("환각증 능력은 7턴 이후부터 사용할 수 있습니다."); return; }
                if (state._0x0010 >= 1) { replier.reply("환각증을 모두 사용했습니다."); return; }
                if (game.history.length > 0 && !isRoot(game.history[game.history.length-1])) {
                    replier.reply("환각증은 루트단어를 받았을 때만 사용할 수 있습니다."); return;
                }
                state._0x0010++;
                state._0x0003 = 2; // 전투 후 본인 디버프
                state._0x0032 = 3;
                _0x007f._0x0005 = true;
                replier.reply("[환자] 환각증 발동! 상대는 1턴간 앞말잇기를 해야합니다.");
            }
        }
        else if (state.job === "감시자" && !_0x0014) {
            if (ability === "탐지") {
                if (state._0x0062 >= 2) { replier.reply("탐지를 모두 사용했습니다."); return; }
                if (state._0x002d > 0) { replier.reply("탐지 쿨타임입니다."); return; }
                state._0x0062++; state._0x002d = 6;
                state._0x0009 = 1;
                replier.reply("[감시자] 탐지 발동! 다음 패시브 발동 시 2배 차감.");
            }
        }
        else if (state.job === "뜀틀선수" && !_0x0014) {
            if (ability === "허들 넘기") {
                if (game._0x0077 < 22) { replier.reply("허들 넘기는 22턴 이상부터 사용 가능합니다."); return; }
                if (state._0x005e >= 1) { replier.reply("허들 넘기 능력을 모두 사용했습니다."); return; }
                state._0x005e++;
                state._0x0076++; state._0x0037 = 0;
                replier.reply("[뜀틀선수] 허들 넘기 발동! 뜀틀 기회 +1 및 쿨타임 초기화.");
            }
        }
        else if (state.job === "전우치" && !_0x0014) {
            if (ability === "직격뢰") {
                if (state._0x0035 >= 4) { replier.reply("직격뢰 능력을 모두 사용했습니다."); return; }
                if (state._0x0011 > 0) { replier.reply("직격뢰 쿨타임입니다."); return; }
                if (!_0x0063) { replier.reply("대상을 지정해주세요."); return; }
                state._0x0035++; state._0x0011 = 7;
                // 금지풀에 넣음
                if (!game._0x005c) game._0x005c = new Set();
                game._0x005c.add(_0x0063);
                replier.reply("[전우치] 직격뢰! '" + _0x0063 + "' 단어가 완전히 소멸했습니다.");
            }
        }
        else if (state.job === "시프터" && !_0x0014) {
            if (ability === "시프트") {
                if (state._0x0070 >= 3) { replier.reply("시프트를 모두 사용했습니다."); return; }
                ...
                game._0x006f.s1 = _0x0081; // 두음 미적용
                game._0x006f.s2 = _0x0081;
                state._0x0070++;
                replier.reply("[시프터] 시프트 발동! 이을 음절 모음이 이동하여 '" + _0x0081 + "' (으)로 변경되었습니다.");
            }
        }
        else if (state.job === "비밀요원" && !_0x0014) {
            if (ability === "포획") {
                // target Param (음절)
                if (state._0x0056 >= 2) { replier.reply("포획을 모두 사용했습니다."); return; }
                if (state._0x001b > 0) { replier.reply("포획 쿨타임입니다."); return; }
                if (!_0x0063 || _0x0063.length !== 1) { replier.reply("포획할 대상 은 1음절이어야 합니다."); return; }
                // 포획 실행 (시뮬레이션 구현상 대상 음절 지정)
                _0x007f._0x0039 = Math.max(_0x007f._0x0039, 2);
                state._0x0056++; state._0x001b = 3;
                replier.reply("[비밀요원] 포획 발동! '" + _0x0063 + "' 로 시작하는 유도/루트 단어가 4개 소멸했으며, 상대방은 2턴간 패시브 및 능력 불가.");
            }
        }
        else if (state.job === "사과" && !_0x0014) {
            if (ability === "사구아") {
                if (state._0x006c >= 1) { replier.reply("사구아 능력을 모두 사용했습니다."); return; }
                state._0x006c++;
                _0x007f._0x0039 = Math.max(_0x007f._0x0039, 3);
                replier.reply("[사과] 사구아 발동! 상대는 3턴간 패시브 및 능력을 잃습니다.");
            }
        }
        else if (state.job === "시인" && !_0x0014) {
            if (ability === "2음절") {
                if (state._0x0044 >= 3) { replier.reply("2음절 능력을 모두 사용했습니다."); return; }
                if (state._0x0016 > 0) { replier.reply("2음절 쿨타임입니다."); return; }
                state._0x0044++; state._0x0016 = 2;
                _0x007f._0x000d = Math.max(_0x007f._0x000d, 1);
                replier.reply("[시인] 2음절 발동! 상대방은 1턴간 2글자 단어만 사용할 수 있습니다.");
            } else if (ability === "시적 허용") {
                if (state._0x0013 >= 2) { replier.reply("시적 허용 능력을 모두 사용했습니다."); return; }
                if (state._0x0002 > 0) { replier.reply("시적 허용 쿨타임입니다."); return; }
                state._0x0013++; state._0x0002 = 3;
                _0x007f._0x0021 = Math.max(_0x007f._0x0021, 1);
                replier.reply("[시인] 시적 허용 발동! 상대방은 1턴간 두음법칙을 사용할 수 없습니다.");
            }
        }
        else if (state.job === "공룡" && !_0x0014) {
            if (ability === "삼키기") {
                if (state._0x0057 >= 2) { replier.reply("삼키기를 모두 사용했습니다."); return; }
                if (state._0x0019 > 0) { replier.reply("삼키기 쿨타임입니다."); return; }
                ...
                state._0x0057++; state._0x0019 = 7; state._0x0033 = true;
                replier.reply("[공룡] 삼키기 발동! 마지막 단어를 삼켜 이전 단어 '" + lastValid + "' 로 되돌렸습니다. 1턴간 3글자 이하 일반단어만 가능.");
            } else if (ability === "브레스") {
                if (game._0x0077 < 10) { replier.reply("10턴부터 사용 가능합니다."); return; }
                if (state._0x0064 >= 1) { replier.reply("브레스를 모두 사용했습니다."); return; }
                state._0x0064++;
                _0x007f._0x0049 = Math.max(_0x007f._0x0049, 1);
                replier.reply("[공룡] 브레스 발동! 상대 유도 금지.");
            } else if (ability === "꼬리 날리기") {
                if (game._0x0077 < 13) { replier.reply("13턴부터 사용 가능합니다."); return; }
                if (state._0x0073 >= 1) { replier.reply("꼬리 날리기를 모두 사용했습니다."); return; }
                state._0x0073++; state._0x0068 = true;
                replier.reply("[공룡] 꼬리 날리기 발동! 다음 턴 능력 불가 상태 무시.");
            }
        }
        else if (state.job === "마법사" && !_0x0014) {
            if (ability === "공허") {
                if (state._0x0074 >= 5) { replier.reply("공허를 모두 사용했습니다."); return; }
                if (state._0x003d > 0) { replier.reply("공허 쿨타임입니다."); return; }
                let _0x0084 = decomposeSyllable(game._0x006f.s2);
                if (_0x0084 && _0x0084.gi > 0) {
                    let _0x0081 = composeSyllable(_0x0084.ci, _0x0084.ji, 0);
                    game._0x006f.s2 = _0x0081;
                    game._0x006f.s1 = applyDuEum(_0x0081);
                    state._0x0074++; state._0x003d = 4;
                    replier.reply("[마법사] 공허 발동! 종성이 지워져 '" + _0x0081 + "' 로 변경되었습니다.");
                } else {
                    replier.reply("종성이 없는 음절입니다.");
                }
            } else if (ability === "폭발") {
                if (game._0x0077 < 14) { replier.reply("14턴 이상 시 사용."); return; }
                if (state._0x0036 >= 1) { replier.reply("모두 사용."); return; }
                state._0x0039 = 0; state._0x0049 = 0; state._0x001c = 0; state._0x0021 = 0;
                state._0x002c = 0; state._0x0030 = 0; state._0x000d = 0; state._0x0032 = 0; state._0x000b = 0;
                state._0x0036++;
                replier.reply("[마법사] 폭발! 모든 디버프가 제거됩니다.");
            }
        }
        else if (state.job === "사신" && !_0x0014) {
            if (ability === "사형 선고") {
                if (state._0x006b >= 4444) return;
                if (state._0x002f > 0) { replier.reply("쿨타임입니다."); return; }
                state._0x006b++; state._0x002f = 4;
                if (state._0x0029 <= 4) {
                    replier.reply("[사신] 사형 선고 발동! (처형 수 4 이하) \n사신이 게임에서 승리합니다!");
                    delete games[room]; return;
                } else if (state._0x0029 <= 18) {
                    _0x007f._0x0032 = Math.max(_0x007f._0x0032, 4); // actually limit words to <=4 length implies >4 length? No, "글자 수가 4글자 이하인 단어를 사용할 수 없습니다." -> must be >4 length.
            ...
            state._0x0004 = true;
            if (ability === "계산") {
                if (state._0x0078>=2) return;
                if (state._0x004c>0) return;
                state._0x0078++; state._0x004c=1;
                replier.reply("[수학자] 스킬 결과: " + state._0x0066);
                if (state._0x0066 === 20) {
                    replier.reply("수학자가 게임에서 승리합니다!");
                    delete games[room]; return;
                }
            } else if (ability === "덧셈") {
                if (state._0x007e>=3) return;
                if (state._0x0053>0) return;
                if(game.history.length>0) state._0x0066 += game.history[game.history.length-1].length;
                state._0x007e++; state._0x0053=2;
                ...
                if (state._0x007d>=1) return;
                if(game.history.length>0) state._0x0066 *= game.history[game.history.length-1].length;
                state._0x007d++;
                replier.reply("[수학자] 곱셈 발동!");
            } else if (ability === "교정") {
                if (state._0x004e>=2) return;
                if (state._0x001f>0) return;
                state._0x0066 += 1;
                state._0x004e++; state._0x001f=4;
                replier.reply("[수학자] 교정 발동!");
            } else if (ability === "미적분") {
                if (state._0x004b>=1) return;
                state._0x004b++;
                _0x007f._0x0039 = Math.max(_0x007f._0x0039, 1);
                replier.reply("[수학자] 미적분 발동! 상대 능력 무력화 1턴.");
            }
        }
        else if (state.job === "생존자" && !_0x0014) {
            if (ability === "긴급 구조") {
                if (state._0x0067 >= 2) return;
                if (state._0x0022 > 0) return;
                ...
                state._0x0067++; state._0x0022 = 7;
                state._0x0007 = 1;
                state._0x0039 = 0; state._0x0049 = 0; state._0x001c = 0; state._0x0021 = 0;
                replier.reply("[생존자] 긴급 구조 발동! 모든 기보가 교체되고 디버프가 제거됩니다. 변경된 마지막 단어: " + lastValid);
            }
        }
        else if (state.job === "악당" && !_0x0014) {
            if (ability === "결계") {
                if (state._0x004f >= 4) return;
                if (state._0x001e > 0) return;
                let dur = game.history.length>0 ? game.history[game.history.length-1].length : 2;
                state._0x004f++; state._0x001e = 5;
                state._0x0042 = dur;
                state._0x001d = ["ㄱ","ㄴ"];
                replier.reply("[악당] " + dur + "턴 간 지속되는 결계 생성!");
            } else if (ability === "왜곡") {
                if (state._0x004d >= 2 || state._0x0042 === 0) return;
                if (state._0x001a > 0) return;
                state._0x004d++; state._0x001a = 1;
                let dict = {"ㄱ":"ㅎ", "ㄴ":"ㅍ", "ㄷ":"ㅌ", "ㄹ":"ㅋ"}; // 간단 매핑, 나머지는 무시
                for(let i=0; i<state._0x001d.length; i++) {
                    if(dict[state._0x001d[i]]) state._0x001d[i] = dict[state._0x001d[i]];
                }
                if (state._0x001d.length >= 4) _0x007f._0x0039 = Math.max(_0x007f._0x0039, 1);
                replier.reply("[악당] 왜곡 발생!");
            }
        }
        else if (state.job === "기자" && !_0x0014) {
            if (ability === "거짓 보도") {
                if (state._0x005a >= 4) return;
                if (state._0x0027 > 0) return;
                state._0x005a++; state._0x0027 = 3; state._0x0051 = 1;
                _0x007f._0x0039 = Math.max(_0x007f._0x0039, 1);
                _0x007f._0x0021 = Math.max(_0x007f._0x0021, 1);
                replier.reply("[기자] 거짓 보도 방송 1턴 전개!");
            }
        }
        else if (state.job === "검객" && !_0x0014) {
            if (ability === "찌르기") {
                if (game._0x0077 < 5) return;
                if (state._0x0079 >= 2) return;
                if (state._0x0043 > 0) return;
                state._0x0079++; state._0x0043 = 5;
                _0x007f._0x0039 = Math.max(_0x007f._0x0039, 1);
                _0x007f._0x0021 = Math.max(_0x007f._0x0021, 1);
                replier.reply("[검객] 찌르기 발동!");
            } else if (ability === "가르기") {
                if (state._0x006d >= 3 || state._0x003c > 0) return;
                ...
                state._0x006d++; state._0x003c = 3;
                if (game._0x0077 < 12) state._0x0050 = true;
                replier.reply("[검객] 가르기 발동! 이을 글자 파편 변경됨: " + game._0x006f.s2);
            }
        }
        else if (state.job === "마하트마간디" && !_0x0014) {
            if (ability === "억제") {
                if (state._0x003f < 1) return;
                if (state._0x0018 > 0) return;
                state._0x003f--; state._0x0018 = 3;
                _0x007f._0x0049 = Math.max(_0x007f._0x0049, 1);
                replier.reply("[마하트마간디] 억제 발동! 상대 1턴간 유도 불가.");
            }
        }
        else if (state.job === "수리사" && !_0x0014) {
            if (ability === "수리") {
                if (state._0x005b >= 4) return;
                if (state._0x002b > 0) return;
                let _0x0084 = decomposeSyllable(game._0x006f.s2);
                ...
                if (_0x0084 && swapMap[_0x0084.jungsung]) {
                    ...
                    game._0x006f.s2 = _0x0081;
                    game._0x006f.s1 = applyDuEum(_0x0081);
                    state._0x005b++; state._0x002b = 6; state._0x0049 = Math.max(state._0x0049, 1);
    ...
    if (msg.startsWith(INPUT_PFX)) {
        ...
        if (game._0x0020 !== -1 && sender !== game.players[game._0x0020]) {
            replier.reply(sender + "님의 차례가 아닙니다."); return;
        }
        
        let state = game._0x0052[sender];
        let _0x0085 = isHanbang(word);
        let _0x0083 = isYudo(word);
        let _0x0086 = isRoot(word);
        let is_exception = _0x0085 || _0x0083;
        
        let _0x007c = game._0x0020 === -1 ? (game.players.indexOf(sender) + 1) % 2 : (game._0x0020 + 1) % 2;
        let _0x007f = game._0x0052[game.players[_0x007c]];
        ...
        // 2. [사전 체크 및 임시단어 허용]
        let _0x0065 = (WORD_SET && WORD_SET.has(word)) || (game._0x0059 && game._0x0059.has(word));
        // 전우치 잔상 (이을 단어 없을 때) 로직은 생략 (판단하기 매우 어려움 - 사용자 자율이거나 우회)
        if (!_0x0065 && state.job === "뜀틀선수" && word === "뜀틀") _0x0065 = true; // 뜀틀선수 특권
        
        if (!_0x0065) {
            if (state.job !== "해커" || state._0x0054 === 0) { // 해커 조작은 사전 외 단어를 허용하는게 아니라 중복을 허용함. 단어 자체는 있어야함.
        ...
        if (game.used.has(word)) {
            if (state.job === "해커" && state._0x0054 > 0) {
        ...
        // 5. [디버프 제약 검사]
        if (state._0x0021 > 0 && word[0] === game._0x006f.s1 && game._0x006f.s1 !== game._0x006f.s2) {
            replier.reply("디버프: 두음법칙을 사용할 수 없습니다."); return;
        }
        if (state._0x001c > 0 && _0x0085) {
            replier.reply("디버프: 한방단어를 사용할 수 없습니다."); return;
        }
        if (state._0x0049 > 0 && _0x0083) {
            replier.reply("디버프: 유도단어를 사용할 수 없습니다."); return;
        }
        if (state._0x002c > 0 && word.length % 2 !== 0) {
            replier.reply("디버프: 짝수 글자 수의 단어만 사용할 수 있습니다."); return;
        }
        if (state._0x0030 > 0 && word.length % 2 === 0) {
            replier.reply("디버프: 홀수 글자 수의 단어만 사용할 수 있습니다."); return;
        }
        if (state._0x000d > 0 && word.length !== 2) {
            replier.reply("디버프: 두 글자 단어만 사용할 수 있습니다."); return;
        }
        if (state._0x0032 > 0 && word.length > state._0x0032) {
            replier.reply("디버프: " + state._0x0032 + "글자 이하의 단어만 사용할 수 있습니다."); return;
        }
        ...
        // 악당 [결계] 검사
        if (_0x007f && _0x007f.job === "악당" && _0x007f._0x0042 > 0) {
            let lastChosung = decomposeSyllable(word[word.length - 1]).chosung;
            if (_0x007f._0x001d.includes(lastChosung)) {
                replier.reply("악당의 결계에 가로막혔습니다! (끝음절 초성 [" + lastChosung + "] 사용 불가)"); return;
            }
        }

        // 기자 [방송] 검사
        if (_0x007f && _0x007f.job === "기자" && _0x007f._0x0051 > 0) {
            if (is_exception) {
                // 음절을 P삐 로 바꿈
                word = word.substring(0, word.length - 1) + "삐";
                state._0x0039 = Math.max(state._0x0039, 1);
                state._0x0049 = Math.max(state._0x0049, 1);
                replier.reply("기자 버프 발동: 방송 중 예외단어를 사용하여, 마지막 음절이 '삐'로 변경되었으며 1턴간 유도 및 능력 불가상태가 됩니다.");
            }
        }

        // 마법사 [부작용] 검사
        if (state.job === "마법사" && game._0x0077 <= 14 && is_exception) {
            replier.reply("마법사 패시브 [부작용]: 14턴 이전에는 한방/유도단어를 사용할 수 없습니다."); return;
        }

        // 기관사 [운행] 검사
        if (_0x007f && _0x007f.job === "기관사" && state.job !== "기관사") {
            // 상대가 기관사이고 전철역 정차중
            if (game._0x0077 % 3 === 0) {
                if (word.length > _0x007f._0x002e) {
                    replier.reply("기관사 전철역 정차 중: 종점까지 남은 역 수(" + _0x007f._0x002e + ")보다 긴 단어를 사용할 수 없습니다."); return;
                }
            }
        }
        ...
        if (game._0x0020 === -1) {
            game._0x0020 = game.players.indexOf(sender);
            game._0x003b = game._0x0020; 
        }
        ...
        // 뜀틀선수 [뜀틀] 패시브
        if (state.job === "뜀틀선수" && word === "뜀틀" && !_0x0014) {
            if (state._0x0069 >= state._0x0076) { replier.reply("뜀틀 사용 횟수가 고갈되었습니다."); return; }
            if (state._0x0037 > 0) { replier.reply("뜀틀 쿨타임입니다."); return; }
            state._0x0069++;
            state._0x0037 = 5;
            _0x007f._0x0049 = Math.max(_0x007f._0x0049, 1);
            _0x007f._0x0039 = Math.max(_0x007f._0x0039, 1);
        ...
        // 해커 초토화 피격 검사
        if (_0x007f && _0x007f.job === "해커" && _0x007f._0x0023 > 0) {
        ...
        // 투자자 패시브
        if (_0x007f && _0x007f.job === "투자자" && !_0x007f._0x0038 && _0x007f._0x0039 === 0) {
            let change = 0;
            if (_0x007f._0x0015) {
                change = -word.length;
                _0x007f._0x0015 = false;
                msgs.push("- 주가 조작 여파: 무조건 차감 (-" + word.length + ")");
            } else {
                change = word.length % 2 === 0 ? -word.length : word.length;
            }
            _0x007f._0x0031 += change;
            let dispStr = change > 0 ? ("상승(+" + change + ")") : ("하락(" + change + ")");
            msgs.push("▶ 투자자 패시브: 주가 " + dispStr + " [현재: " + _0x007f._0x0031 + " / 승리 목표: " + game._0x0077 + " 이내]");
            if (_0x007f._0x0031 <= game._0x0077) {
        ...
        // 환자 [강박증]
        if (_0x007f && _0x007f.job === "환자" && !_0x007f._0x0038 && _0x007f._0x0039 === 0) {
            if (word.length % 2 !== 0 && _0x007f._0x004a === 0) { // 홀수 단어 사용시
                _0x007f._0x004a = 3;
                state._0x002c = Math.max(state._0x002c, 1);
                state._0x0039 = Math.max(state._0x0039, 1);
                state._0x0049 = Math.max(state._0x0049, 1);
        ...
        // 수집가 [수집]
        if (_0x007f && _0x007f.job === "수집가" && !_0x007f._0x0038 && _0x007f._0x0039 === 0) {
            let collected = [word[0]];
            if (_0x007f._0x0061 > 0) { collected = word.split(''); _0x007f._0x0061 = 0; msgs.push("- 채굴 효과로 모든 음절 수집!"); }
            _0x007f._0x000e = _0x007f._0x000e.concat(collected);
            msgs.push("▶ 수집가 [수집]: [" + collected.join(",") + "] 음절 휙득.");
        }
        if (state.job === "수집가" && game._0x0059 && game._0x0059.has(word)) { // 추가단어 사용
            _0x007f._0x0039 = Math.max(_0x007f._0x0039, 1);
            msgs.push("▶ 수집가 [추가단어 사용]: 상대는 1턴간 능력 불가!");
            game._0x0059.delete(word);
        }

        // 감시자 [감시]
        if (_0x007f && _0x007f.job === "감시자" && !_0x007f._0x0038 && _0x007f._0x0039 === 0) {
            let deduction = 0;
            if (_0x0083) deduction += 4;
            if (_0x0085) deduction += 8;
            if (_0x0086) deduction += 2;
            
            let debuff_count = (_0x007f._0x0039 > 0 ? 1 : 0) + (_0x007f._0x0049 > 0 ? 1 : 0) + (_0x007f._0x001c > 0 ? 1 : 0) + (_0x007f._0x0021 > 0 ? 1 : 0);
            deduction += debuff_count;

            if (_0x007f._0x0009 > 0) {
                deduction *= 2;
                _0x007f._0x0009 -= 1;
            }

            if (deduction > 0) {
                _0x007f._0x005d -= deduction;
                msgs.push("▶ 감시자 [감시]: 위반 행위 포착! (감시 수 -" + deduction + " 됨, 현재: " + _0x007f._0x005d + ")");
                if (_0x007f._0x005d <= 0) {
                    _0x007f._0x005d = 0;
        ...
        // 늑대인간 [포효]
        if (state.job === "늑대인간" && !_0x0014 && state._0x0041 === 0) {
            let count = (word.match(/[ㅇㅎ]/g) || []).length;
            if (count >= 1) {
                _0x007f._0x002c = Math.max(_0x007f._0x002c, 2);
        ...
        // 비밀요원 [타깃 확보]
        if (state.job === "비밀요원" && !_0x0014 && state._0x0082.length === 0) {
            // To simulate taking up to 3 long valid words. We arbitrarily just set state._0x0082 for design (skip real DB scan for brevity unless needed)
            state._0x0082 = ["타깃1", "타깃2"]; // 실 구현 시 DB검색이 들어가야하지만 동기식 부하로 임시 처리
            msgs.push("▶ 비밀요원 [타깃 확보] 발동: 타깃 단어가 설정되었습니다.");
        }
        if (_0x007f && _0x007f.job === "비밀요원" && _0x007f._0x0082.includes(word)) {
            state._0x0039 = Math.max(state._0x0039, 1);
            state._0x000b = 2;
        ...
        // 67 [67]
        if (state.job === "67" && !_0x0014 && state._0x000c === 0) {
            if (word.length === 6) {
                state._0x000c = 1;
                if (_0x007f._0x0049 > 0) _0x007f._0x0049 += 7;
                else {
                    _0x007f._0x0049 = Math.max(_0x007f._0x0049, 7);
                    _0x007f._0x001c = Math.max(_0x007f._0x001c, 1);
                }
                msgs.push("▶ 67 발동! 상대는 유도 불가 연장 및 1턴 한방 불가.");
                if (_0x007f._0x0049 >= 67) {
                    replier.reply(msgs.join("\n"));
                    replier.reply("67(" + game.players[game._0x0020] + ")가 유도 스택 67을 달성하여 즉시 승리합니다!");
                    delete games[room]; return;
                }
            }
        }
        ...
        // 사과 [삭와]
        if (state.job === "사과" && !_0x0014) {
            if (state._0x0001 === 0) {
                let _0x0071 = 0;
                let _0x007b = decomposeSyllable(word[0]);
                let _0x0075 = decomposeSyllable(word[word.length - 1]);
                let checkArr = ["ㅅ","ㄱ","ㄴ","ㅁ","ㅇ"];
                if (_0x007b && checkArr.includes(_0x007b.chosung)) _0x0071++;
                if (_0x0075 && checkArr.includes(_0x0075.jongsung)) _0x0071++;
                
                if (_0x0071 >= 2) {
                    if (state._0x000f >= 10) {
                        replier.reply("사과(" + game.players[game._0x0020] + ")의 삭와 패시브가 10턴 숙성되어 발동하면서 즉시 승리합니다!");
                        delete games[room]; return;
                    }
                    if (_0x007f._0x0012 > 0) _0x007f._0x0012 += 2;
                    else _0x007f._0x0012 = 3;
                    state._0x0001 = 2;
                    state._0x000f = 0;
        ...
        // 마하트마간디 [비폭력]
        if (_0x007f && _0x007f.job === "마하트마간디" && !_0x007f._0x0038) {
            if (_0x0085 || _0x0083) {
                _0x007f._0x003f++;
                msgs.push("▶ 마하트마간디 [비폭력]! 스택 증가 (현재: " + _0x007f._0x003f + ")");
            }
            if (_0x007f._0x003f >= 4) {
                replier.reply(msgs.join("\n"));
        ...
        // 사신 [처형]
        if (state.job === "사신" && !_0x0014) {
            state._0x0029 -= word.length;
            if (word.length >= 8) {
                _0x007f._0x0039 = Math.max(_0x007f._0x0039, 1);
                _0x007f._0x001c = Math.max(_0x007f._0x001c, 1);
                _0x007f._0x0049 = Math.max(_0x007f._0x0049, 1);
        ...
        if (_0x007f && _0x007f.job === "악당" && _0x007f._0x0042 > 0) {
            ...
            for (let i = 0; i < additionalCount && _0x007f._0x001d.length < adds.length + 2; i++) {
                let nextIdx = _0x007f._0x001d.length - 2;
                if (nextIdx >= 0 && nextIdx < adds.length) {
                    _0x007f._0x001d.push(adds[nextIdx]);
                }
            }
        }
        ...
        // 턴 갱신 및 상태 감소
        // ==========================
        if (state._0x0054 > 0) state._0x0054 -= 1;
        if (state._0x003a > 0) state._0x003a -= 1;
        if (state._0x0017 > 0) state._0x0017 -= 1;
        if (state._0x000a > 0) state._0x000a -= 1;
        if (state._0x004a > 0) state._0x004a -= 1;
        if (state._0x0047 > 0) state._0x0047 -= 1;
        if (state._0x0040 > 0) state._0x0040 -= 1;
        if (state._0x002d > 0) state._0x002d -= 1;
        if (state._0x0037 > 0) state._0x0037 -= 1;
        if (state._0x0011 > 0) state._0x0011 -= 1;
        if (state._0x0041 > 0) state._0x0041 -= 1;
        if (state._0x001b > 0) state._0x001b -= 1;
        if (state._0x000c > 0) state._0x000c -= 1;
        if (state._0x0001 > 0) state._0x0001 -= 1;
        if (state._0x0016 > 0) state._0x0016 -= 1;
        if (state._0x0002 > 0) state._0x0002 -= 1;
        if (state._0x0019 > 0) state._0x0019 -= 1;
        if (state._0x003d > 0) state._0x003d -= 1;
        if (state._0x002f > 0) state._0x002f -= 1;
        if (state._0x004c > 0) state._0x004c -= 1;
        if (state._0x0053 > 0) state._0x0053 -= 1;
        if (state._0x001f > 0) state._0x001f -= 1;
        if (state._0x0025 > 0) state._0x0025 -= 1;
        if (state._0x0022 > 0) state._0x0022 -= 1;
        ...
        if (state._0x003c > 0) state._0x003c -= 1;
        if (state._0x0028 > 0) state._0x0028 -= 1;
        ...
        if (state._0x0049 > 0) state._0x0049 -= 1;
        if (state._0x001c > 0) state._0x001c -= 1;
        if (state._0x0021 > 0) state._0x0021 -= 1;
        if (state._0x002c > 0) state._0x002c -= 1;
        if (state._0x0030 > 0) state._0x0030 -= 1;
        if (state._0x000d > 0) state._0x000d -= 1;
        if (state._0x0032 > 0) state._0x0032 = 0;
        if (state._0x000b > 0) state._0x000b -= 1;
        if (state._0x0003 > 0) state._0x0003 -= 1;
        if (state._0x0042 > 0) state._0x0042 -= 1;
        if (state._0x0051 > 0) state._0x0051 -= 1;
        if (state._0x0012 > 0) state._0x0012 -= 1;

        if (state._0x0033) state._0x0033 = false;
        if (state._0x0068) state._0x0068 = false;
        if (state._0x0050) state._0x0050 = false;

        // 수학자 연산 시도 마커 해제
        if (_0x007f && _0x007f.job === "마하트마간디" && state._0x0004) {
            _0x007f._0x003f++;
            msgs.push("▶ 마하트마간디 [비폭력] (스킬 사용 조건): 스택 증가 (현재: " + _0x007f._0x003f + ")");
            state._0x0004 = false;
        } else if (state._0x0004) {
            state._0x0004 = false;
        }
